$(document).ready(function () {
    ...
    const apiGetPost = "/api/v1/student_courses/courses/" + courseID + "/posts/" + postID + "/details"
    ...
    $.get(apiGetPost, function (response) {
        ...
        $(".post-body").append(`<p>${data.PostBody}</p>`)
        ...
        commentContent.on("click", ".delete-comment", function (){
            ...
            $('#confirmDelete').on('click', function () {
                ...
                $.ajax({
                    url: "/api/v1/courses/" + courseID + "/comments/" + commentID,
                    method: "DELETE",
                    success: function (respone) {
                        let data = respone.data
                        commentContent.empty()
